    ...
    "comparison": {
        ...
        "slides": [
            ...
            },
            {
                ...
                "content_instruction": "Top half: Contender A identity. Bottom half: massive stat showing its strength.",
            ...
            },
            {
                ...
                "content_instruction": "Main stat = the winning metric. Secondary stats = supporting data. Insight = why this matters.",
            ...
            },
            {
                ...
                "content_instruction": "Top: context for the second comparison. Bottom: massive stat showing the gap.",
    ...
    "explainer": {
        ...
        "slides": [
            ...
            },
            {
                ...
                "layout": "bento",
                "density": "high",
                "purpose": "30-second summary — the big number + 2 supporting facts",
                "content_instruction": "Main stat = the most shocking number about this concept. Secondary stats = supporting evidence.",
            ...
            },
            {
                ...
                "content_instruction": "Top: the context/conventional wisdom. Bottom: the surprising stat that challenges it.",
    ...
    "analysis": {
        ...
        "slides": [
            ...
            },
            {
                ...
                "content_instruction": "Main stat = the before/starting metric. Secondary = scale. Third = timeline.",
                "content_fields": ["main_stat", "main_label", "stat2_value", "stat2_label", "stat3_value", "stat3_label", "insight"]
            },
            {
                "position": "strategy",
            ...
            },
            {
                ...
                "layout": "split",
                "density": "medium",
                "purpose": "The results — after state with massive number",
    ...
    "listicle": {
        ...
        "slides": [
            ...
            },
            {
                ...
                "content_instruction": "Main = item 1 with big number. Secondary = item 2. Insight = why these matter.",
            ...
            },
            {
                ...
                "content_instruction": "Top: item 3 context. Bottom: item 4 with stat.",
                "content_fields": ["context", "stat_value", "stat_label", "insight"]
            },
            {
                "position": "items_5_6",
    ...
    "myth_busting": {
        ...
        "slides": [
            ...
            },
            {
                ...
                "content_instruction": "Top: the myth/belief. Bottom: the reality with a shocking stat.",
                "content_fields": ["context", "stat_value", "stat_label", "insight"]
            },
            {
                "position": "myth_2",
                ...
                "content_instruction": "Main stat = the real number. Secondary = supporting data. Insight = why this myth persists.",
                "content_fields": ["main_stat", "main_label", "stat2_value", "stat2_label", "insight"]
            },
            {
                "position": "myth_3",
    ...
    "transformation": {
        ...
        "slides": [
            ...
            },
            {
                ...
                "content_instruction": "Main stat = the pain metric. Secondary = scope. Third = cost of inaction.",
                "content_fields": ["main_stat", "main_label", "stat2_value", "stat2_label", "stat3_value", "stat3_label", "insight"]
            },
            {
                ...
                "content_instruction": "Top: the catalyst. Bottom: the first result.",
                "content_fields": ["context", "stat_value", "stat_label", "insight"]
            },
            {
                "position": "phases",
    ...
    "framework": {
        ...
        "slides": [
            ...
            },
            {
                ...
                "content_instruction": "Main stat = the key metric this framework optimizes. Secondary = adoption/result. Insight = why it works.",
                "content_fields": ["main_stat", "main_label", "stat2_value", "stat2_label", "insight"]
            },
            {
            ...
            },
            {
                ...
                "content_instruction": "Top: application context. Bottom: result metric.",
                "content_fields": ["context", "stat_value", "stat_label", "insight"]
            },
            {
...
def get_layout_for_position(arc_id: str, position: int) -> str:
    """Get the recommended layout for a specific position in an arc."""
    blueprint = get_slide_blueprint(arc_id, position)
    return blueprint.get("layout", "hero")
